...
WebUI.setText(findTestObject('Object Repository/AdminPanel/Organization/Add users to organization/Page_Growloop Admin/input_Enter email_undefined'), 
    'Sadhani@ideabits.se')
...
WebUI.setText(findTestObject('Object Repository/AdminPanel/Organization/Add users to organization/Page_Growloop Admin/input_Enter email_undefined'), 
    'Sadhani@ideabits.ses')

WebUI.click(findTestObject('Object Repository/AdminPanel/Organization/Add users to organization/Page_Growloop Admin/button_Add Users to Organization'))

WebUI.verifyElementText(findTestObject('Object Repository/AdminPanel/Organization/Add users to organization/Page_Growloop Admin/span_sadhaniideabits.se'), 
    'sadhani@ideabits.se')

WebUI.verifyElementText(findTestObject('Object Repository/AdminPanel/Organization/Add users to organization/Page_Growloop Admin/span_sadhaniideabits.ses'), 
    'sadhani@ideabits.ses')
